...
// 1a86:55da QinHeng Electronics USB To Dual_Serial
// 1a86:55db QinHeng Electronics USB To UART+SPI+I2C
// 1a86:55dc QinHeng Electronics HID To UART+SPI+I2C
// 1a86:55dd QinHeng Electronics USB To UART+JTAG
#define CH347_VID 0x1a86
#define CH347_DUAL_PID 0x55da
#define CH347_VCP_PID 0x55db
#define CH347_HID_PID 0x55dc
#define CH347_JTAG_PID 0x55dd

#define CH347_DUAL_CDC1_CONTROL_IF 0
#define CH347_DUAL_CDC1_DATA_IF 1
#define CH347_DUAL_CDC2_CONTROL_IF 2
#define CH347_DUAL_CDC2_DATA_IF 3

#define CH347_VCP_CDC_CONTROL_IF 0
#define CH347_VCP_CDC_DATA_IF 1
#define CH347_VCP_CH347_IF 2
#define CH347_VCP_CH347_EPOUT (6 | LIBUSB_ENDPOINT_OUT)
#define CH347_VCP_CH347_EPIN (6 | LIBUSB_ENDPOINT_IN)

#define CH347_HID_HID_IF 0
#define CH347_HID_CH347_IF 1
#define CH347_HID_CH347_EPOUT (6 | LIBUSB_ENDPOINT_OUT)
#define CH347_HID_CH347_EPIN (6 | LIBUSB_ENDPOINT_IN)

#define CH347_JTAG_CDC_CONTROL_IF 0
#define CH347_JTAG_CDC_DATA_IF 1
#define CH347_JTAG_CH347_IF 3
